    ...
    for phase, dataset_opt in opt['datasets'].items():
        if phase == 'train' and args.phase != 'val':
            ...
            train_dataset = FD(split='train',
                               ...
                               ir_path='../low',  # 训练的时候是 true，n.py改为低光
                               vi_path='../low',  # 一直是 低光
                               sourse_path='../high',  # 是 true
                               is_crop=True)
            ...
            for _, (train_data, _) in enumerate(train_loader):
                ...
                if current_step % opt['train']['val_freq'] == 0:
                    ...
                    for _, (val_data, _) in enumerate(val_loader):
                        ...
                        diffusion.test_concat(in_channels=3,
                        ...
                        # generation
                        Metrics.save_img(
                            sam_img, '{}/sample_{}.png'.format(result_path, current_step))
